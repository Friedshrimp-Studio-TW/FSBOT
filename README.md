...
<p align="center">
        ...
        <tr>
            ...
            <td><code>/setjoin</code> | 用戶加入群組相關設定\n(需有 <code>管理者</code> 權限)</td>
            <td align="center">⚠️暫無⚠️</td>
            <td><code>/embed</code> | 發送嵌入訊息\n(需有 <code>管理訊息</code> 權限)</td>
        </tr>
        <tr>
            <td><code>/avatar</code> | 查看用戶頭像</td>
            <td><code>/setleave</code> | 用戶離開群組相關設定\n(需有 <code>管理者</code> 權限)</td>
            <td></td>
            <td><code>/ban</code> | 封鎖成員\n(需有 <code>對成員停權</code> 權限)</td>
        </tr>
        <tr>
            <td><code>/userinfo</code> | 查看用戶數據</td>
            <td></td>
            <td></td>
            <td><code>/kick</code> | 踢出成員\n(需有 <code>踢出成員</code> 權限)</td>
        </tr>
        <tr>
